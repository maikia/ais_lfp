...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 8, 4);
 	...
 	ivoc_help("help ?1 Kv7 /home/maria/maja/articles/lfp_phd/final code/data/HallermannEtAl2012/x86_64/Kv7.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Kv7-current";
...
double alpha ( _threadargsprotocomma_ double _lv ) {
   double _lalpha;
 _lalpha = 0.00623 * exp ( ( _lv - vhalf ) / 18.76 ) ;
...
double beta ( _threadargsprotocomma_ double _lv ) {
   double _lbeta;
 _lbeta = 0.0199 * exp ( - ( _lv - vhalf ) / 30.6 ) ;
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
  ...
  m = m0;
 {
   m = alpha ( _threadargscomma_ v ) / ( beta ( _threadargscomma_ v ) + alpha ( _threadargscomma_ v ) ) ;
   }
