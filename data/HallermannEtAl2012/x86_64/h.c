...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 6, 1);
 	...
 	ivoc_help("help ?1 ih /home/maria/maja/articles/lfp_phd/final code/data/HallermannEtAl2012/x86_64/h.mod\n");
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
  ...
  h = h0;
 {
   h = alpha ( _threadargscomma_ v ) / ( beta ( _threadargscomma_ v ) + alpha ( _threadargscomma_ v ) ) ;
   }
